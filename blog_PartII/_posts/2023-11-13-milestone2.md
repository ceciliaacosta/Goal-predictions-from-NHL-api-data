...
1. Encoder des variables catégorielles : L'algorithme XGBoost fonctionne avec des types numériques et vu que notre dataset contient des valeurs catégorielles on a la techniques encodage leave on out. 
